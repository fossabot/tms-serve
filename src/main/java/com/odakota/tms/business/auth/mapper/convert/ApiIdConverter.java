 ...
 */
@Converter
public class ApiIdConverter implements AttributeConverter<ApiId, Integer> {
     ...
     */
    @Override
    public Integer convertToDatabaseColumn(ApiId attribute) {
     ...
     */
    @Override
    public ApiId convertToEntityAttribute(Integer dbData) {
        return ApiId.of(dbData);
    }
}
