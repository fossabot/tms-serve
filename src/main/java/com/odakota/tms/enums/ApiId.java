...
public enum ApiId {
    ...
    C_ACCOUNT(5, "Create account"),
    R_ACCOUNT(6, "Read account"),
    U_ACCOUNT(7, "Update account"),
    D_ACCOUNT(8, "Delete account"),
    C_USER(9, "Create user"),
    R_USER(10, "Read user"),
    U_USER(11, "Update user"),
    D_USER(12, "Delete user"),
    C_DIVISION(13, "Create division"),
    R_DIVISION(14, "Read division"),
    U_DIVISION(15, "Update division"),
    D_DIVISION(16, "Delete division"),
